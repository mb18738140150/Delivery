...
-(void)createButton{
    _textLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 60, 320, 60)];
...
-(void)getLat
{
    ...
    if (IS_IOS8) {
        [[CCLocationManager shareLocation] getLocationCoordinate:^(CLLocationCoordinate2D locationCorrrdinate) {
            ...
            [self pushwithLocationCoordinate:locationCorrrdinate];
...
- (void)pushwithLocationCoordinate:(CLLocationCoordinate2D )locationCoordinate
{
    Mapcontroller * oVC = [[Mapcontroller alloc]init];
    oVC.coordinate2D = locationCoordinate;
