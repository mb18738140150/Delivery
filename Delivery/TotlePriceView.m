...
- (void)createSubviews
{
    UILabel * totleLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.width - 2 * LEFT_SPACE - 2 * DEALBUTTON_WIDTH - PRICELABEL_WIDTH - 30, TOP_SPACE + 5, 30, 30)];
    totleLabel.text = @"总¥";
    ...
    self.totlePriceLabel = [[UILabel alloc]initWithFrame:CGRectMake(totleLabel.right, TOP_SPACE + 5, PRICELABEL_WIDTH , 30)];
...
//    _totlePriceLabel.adjustsFontSizeToFitWidth = YES;
    ...
    _detailsButton.frame = CGRectMake(_totlePriceLabel.right, TOP_SPACE, DEALBUTTON_WIDTH, BUTTON_HEIGHT);
